<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-ct-black.png" alt=""> <span>Brytons Tech</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/addstudent">
						...
						<span class="label">Add Semi-admin</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/addfees">
						...
						<span class="label">Cast Vote</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/feesreports">
						<span class="icon">
							<svg width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
								<title>duplicate</title>
								<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
			...
			<div class="aside-footer">
				<div class="footer-box">
					...
					<a-button type="primary" href="https://scanpal.co.ke" block target="_blank">
						CONTACT US
					</a-button>
				</div>
			</div>
