				...
				<a-row type="flex" align="middle">
					<a-col :span="24" :md="12" class="col-info">
						...
						<div class="avatar-info">
							<h4 class="font-semibold m-0">St. Isaac Academy</h4>
							<p>Fee Structure</p>
						</div>
					</a-col>
					<a-col :span="24" :md="12" style="display: flex; align-items: center; justify-content: flex-end">
						<a-radio-group v-model="profileHeaderBtns" size="small">
							<a-radio-button value="overview">TERM ONE</a-radio-button>
							<a-radio-button value="teams">TERM TWO</a-radio-button>
							<a-radio-button value="projects">TERM THREE</a-radio-button>
                            <a-radio-button value="projects">TRANSPORT</a-radio-button>
						</a-radio-group>
					</a-col>
				</a-row>
			</template>
